...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String DB_URL = "jdbc:postgresql://localhost:5432/saftech";
        ...
        post("/departments", (req, res) -> {
            ...
            req.session().attribute("createdDepartment","Department added");
        ...
        post("/departments/:id", (req, res) -> {
            ...
            req.session().attribute("updatedDepartment","Department updated");
            res.redirect("/departments");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        post("/departments/:id/members", (req, res) -> {
            ...
            req.session().attribute("createdStaff","Staff Member added ");
        ...
        get("/departments/:id/delete", (req, res) -> {
            ...
            req.session().attribute("deletedDepartment","Department deleted ");
            res.redirect("/departments");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        post("/staff/:id", (req, res) -> {
            ...
            req.session().attribute("updatedStaff","Staff Member updated");
            res.redirect("/staff");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        get("/staff/:id/delete", (req, res) -> {
            ...
            req.session().attribute("deletedStaff","Staff Member deleted");
            res.redirect("/staff");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        post("/roles", (req, res) -> {
            ...
            req.session().attribute("createdRole","Role added");
            res.redirect("/roles");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        post("/roles/:id", (req, res) -> {
            ...
            req.session().attribute("updatedRole","Role updated.");
            res.redirect("/roles");
            return null;
        }, new HandlebarsTemplateEngine());
        ...
        get("/roles/:id/delete", (req, res) -> {
            ...
            req.session().attribute("deletedRole","Role deleted.");
            res.redirect("/roles");
            return null;
        }, new HandlebarsTemplateEngine());
    }
